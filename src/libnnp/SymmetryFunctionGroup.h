...
public:
     ...
     */
    KOKKOS_INLINE_FUNCTION virtual void calculate(System* s, AoSoA_NNP nnp_data, 
     ...
     *                        calculated and saved.
     */
    KOKKOS_INLINE_FUNCTION virtual void calculate_derivatives(System* s, AoSoA_NNP nnp_data, t_dGdr dGdr, 
