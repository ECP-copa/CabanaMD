...
inline bool SymmetryFunctionAngularNarrow::
...
inline bool SymmetryFunctionAngularNarrow::getUseIntegerPow() const
{
    return useIntegerPow;
}

inline std::size_t SymmetryFunctionAngularNarrow::getE1() const
{
    return e1;
}
...
inline int SymmetryFunctionAngularNarrow::getZetaInt() const
{
    return zetaInt;
}

inline double SymmetryFunctionAngularNarrow::getLambda() const
{
    return lambda;
}

inline double SymmetryFunctionAngularNarrow::getEta() const
{
    return eta;
}
