...
size_t const SymmetryFunctionHelper::sfinfoWidth = 12;

SymmetryFunctionHelper::PrintFormat const
SymmetryFunctionHelper::printFormat = initializePrintFormat();

SymmetryFunctionHelper::PrintOrder const
SymmetryFunctionHelper::printOrder = initializePrintOrder();

vector<string> SymmetryFunctionHelper::parameterInfo() const
{
    vector<string> v;
    string s;
...
SymmetryFunctionHelper::SymmetryFunctionHelper(size_t type, ElementMap const& elementMap) :
    type         (type                   ),
...
double SymmetryFunctionHelper::scale(double value) const
{
...
KOKKOS_INLINE_FUNCTION double SymmetryFunctionHelper::unscale(double value) const
{
    if (scalingType == ST_NONE)
    {
        return value;
...
SymmetryFunctionHelper::PrintFormat const SymmetryFunctionHelper::initializePrintFormat()
{
    PrintFormat pf;
...
SymmetryFunctionHelper::PrintOrder const SymmetryFunctionHelper::initializePrintOrder()
{
    vector<string> po;
...
string SymmetryFunctionHelper::getPrintFormat() const
{
    string s;
