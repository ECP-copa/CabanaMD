...
public:
     ...
     */
    KOKKOS_INLINE_FUNCTION void calculate(System* s, AoSoA_NNP nnp_data, t_verletlist_full_2D neigh_list, T_INT i, bool const derivatives) const;
    
    KOKKOS_INLINE_FUNCTION void calculate_derivatives(System* s, AoSoA_NNP nnp_data, t_dGdr dGdr, t_verletlist_full_2D neigh_list, T_INT i) const;
