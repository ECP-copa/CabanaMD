...
inline double Mode::getMeanEnergy() const { return meanEnergy; }

inline double Mode::getConvEnergy() const { return convEnergy; }

inline double Mode::getConvLength() const { return convLength; }

inline double Mode::getMaxCutoffRadius() const { return maxCutoffRadius; }

inline std::size_t Mode::getNumElements() const { return numElements; }

inline bool Mode::useNormalization() const { return normalize; }

//------------------- HELPERS TO MEGA FUNCTION  --------------//

KOKKOS_INLINE_FUNCTION void
Mode::compute_cutoff( CutoffFunction::CutoffType cutoffType, double &fc,
                      double &dfc, double r, double rc, bool derivative )
{
    double temp;
...
KOKKOS_INLINE_FUNCTION double Mode::scale( int attype, double value, int k,
